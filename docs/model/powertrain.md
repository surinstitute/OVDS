...
In v0.2.0, the vehicle schema stores role-based powertrain usage references inside the vehicle record. The reusable entities themselves live in their own schemas under `spec/v0.2.0/`.
