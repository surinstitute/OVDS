...
This documentation tree is intentionally tool-agnostic so it can later be published with MkDocs, Starlight, or another documentation generator without rewriting the content model.
